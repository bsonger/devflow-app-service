...
Detailed resource documentation for `devflow-app-service`.

## Purpose

This folder is the repo-local source for resource field documentation.
...
- `Lifecycle / Status Fields` when applicable
- `Create / Update Rules`
- `Validation Notes`
- `Source Pointers`
