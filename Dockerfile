...
RUN CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o devflow-app-service ./cmd
...
COPY --from=builder /app/devflow-app-service ./devflow-app-service
...
ENTRYPOINT ["./devflow-app-service"]
